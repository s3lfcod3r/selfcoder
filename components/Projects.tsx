      ...
      <div className="mt-6 flex flex-wrap gap-2">
        {p.url && (
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-[#33a78c66] bg-[#33a78c1a] px-3 py-2 font-mono text-xs text-teal transition-colors hover:bg-[#33a78c33]"
          >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-lg border border-[var(--color-line)] px-3 py-2 font-mono text-xs text-[var(--color-muted)] transition-colors hover:border-teal hover:text-teal"
        >
